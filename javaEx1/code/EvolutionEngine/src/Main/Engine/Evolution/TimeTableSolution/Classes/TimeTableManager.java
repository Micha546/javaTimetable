...
public class TimeTableManager implements AlgorithmManager {
    ...
    private Map<TimeTableMutations, Pair<Integer, Object[]>> mutationsPairMap;
    ...
    public TimeTableManager(ETTDescriptor ettDescriptor) {
        ...
        this.mutationsPairMap = getMutationsFromETT(ettDescriptor.getETTEvolutionEngine().getETTMutations());
    ...
    private Map<TimeTableMutations, Pair<Integer, Object[]>> getMutationsFromETT(ETTMutations ettMutations)
    {
        Map<TimeTableMutations, Pair<Integer, Object[]>> mutationMap = new HashMap<>();
        ...
        for(ETTMutation mutation : ettMutations.getETTMutation())
        {
            ...
            mutationMap.put(timeTableMutation, new Pair<>(probability, argsList.toArray()));
        }
    ...
    private List<Object> getRuleArgs(ETTRule ettRule)
    {
        ...
        if(ettRule.getETTConfiguration().size() != 0)
        {
            throw new RuntimeException("Implement getting args for Sequentially");
        }
    ...
    public List<Mutation> getMutations() {
        return new ArrayList<>(mutationsPairMap.keySet());
    }

    @Override
    public Object[] getMutationArguments(Mutation mutation) {
        return mutationsPairMap.get(mutation).getValue();
    }

    @Override
    public Integer getMutationProbability(Mutation mutation) {
        return mutationsPairMap.get(mutation).getKey();
    }
    ...
    public InformationCarrier getDTOCrossOver(CrossOver crossOver)
    {
        ...
        return new DTOTimeTableCrossOver((TimeTableCrossOvers) crossOver, crossOverCutSize);
    }

    @Override
    public InformationCarrier getDTOMutation(Mutation mutation) {
        if(!(mutation instanceof TimeTableMutations))
            throw new RuntimeException(this.getClass().getName() + " expected to get a TimeTableMutation");

        TimeTableMutations timeTableMutation = (TimeTableMutations) mutation;

        return new DTOTimeTableMutation(timeTableMutation,
                mutationsPairMap.get(timeTableMutation).getKey(),
                Arrays.stream(mutationsPairMap.get(timeTableMutation).getValue()).collect(Collectors.toList()));
    }
    ...
    public InformationCarrier getDTOSelection(Selection selection) {
        ...
        return new DTOTimeTableSelection(timeTableSelection, Arrays.stream(selectionArgs).collect(Collectors.toList()));
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(days, that.days) && Objects.equals(hours, that.hours) &&
                ...
                Objects.equals(mutationsPairMap, that.mutationsPairMap) && selection == that.selection &&
    ...
    public int hashCode() {
        int result = Objects.hash(days, hours, allGrades, allSubjects, allTeachers, crossOver,
                crossOverCutSize, mutationsPairMap, selection, rulesPairMap, hardRuleWeight, populationSize);
