...
public class TimeTableManager implements AlgorithmManager {
    ...
    private List<TimeTableMutationWrapper> mutationsWrapperList;
    ...
    public TimeTableManager(ETTDescriptor ettDescriptor) {
        ...
        this.crossOver = TimeTableCrossOvers.DayTimeOriented;
        this.crossOverCutSize = 2;
        this.crossOverArgs = new Object[] {};

        this.mutationsWrapperList = new ArrayList<>();

        this.selection = TimeTableSelections.Truncation;
        this.selectionArgs = new Object[] {10}; //topPercent = 10
        this.elitism = 0;
